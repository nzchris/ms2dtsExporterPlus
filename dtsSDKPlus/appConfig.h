...
namespace DTS
{
   typedef void (*progressfnptr)(void*,F32,F32,const char*);
   ...
   protected:
      ...
      virtual bool readConfigFile(const char * filename);
      ...
      // progress handling
      void setProgressCallback(progressfnptr callback, void *arg=0);
      ...
      {
         smConfig->mErrorMessages.clear();
         smConfig->mWarningMessages.clear();
      }
      ...
      static void SetEnableSequences(bool enable) { smConfig->mEnableSequences = enable; }
      ...
      // progress handling
      static void SetProgressCallback(progressfnptr callback, void *arg=0) { smConfig->setProgressCallback(callback, arg); }
