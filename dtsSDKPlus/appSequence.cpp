...
namespace DTS
{
   ...
   void AppSequenceNode::getSequenceData(AppSequenceData * seqData)
   {
      ...
      seqData->frameRate = AppConfig::AppFramesPerSec();
   ...
   Trigger AppSequenceNode::getTrigger(S32 idx)
   {
      ...
      // convert from 'app' time to actual sequence time
      F32 actualDuration = seqData.duration.getF32() * AppConfig::AppFramesPerSec() / seqData.frameRate;
      F32 actualStart = seqData.startTime.getF32() * AppConfig::AppFramesPerSec() / seqData.frameRate;
      ...
      if (seqData.duration.getF32()<0.001f)
         ...
         ret.pos = F32(frame/seqData.frameRate-actualStart)/actualDuration;
      return ret;
   }
